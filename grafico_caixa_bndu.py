...
ADJ_OLD = {"06/18": 7031.7, "12/18": 8973.5, "06/19": 8344.8, "12/19": 6808.7, "06/20": 5683.5, "12/20": 3936.5}   # 'Imóveis adjudicados/arrematados' dentro de bens não de uso (nota antiga; 2018-19 das DCs em Word do RI)
...
ks = ["06/18", "12/18", "06/19", "12/19", "06/20"] + list(REC)
...
g.append(f'<text x="{x(ks.index("12/18")):.1f}" y="{y(ADJ_OLD["12/18"]/1000)-6:.1f}" text-anchor="middle" class="fw-s2" fill="{S1}">{fmt(ADJ_OLD["12/18"]/1000, 1)}</text>')
...
num = {"rec_now": REC["06/26"], "rec_min": REC[lo], "rec_min_k": lo, "rec_1220": REC["12/20"], "adj_1219": ADJ_OLD["12/19"], "adj_1218": ADJ_OLD["12/18"], "prov_now": PROV["06/26"], "desp_2025": DESP["1S25"] + DESP["2S25"], "desp_2022": DESP["1S22"] + DESP["2S22"], "desp_1s26": DESP["1S26"]}
