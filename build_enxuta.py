...
_cards = ('<div class="cards3" style="margin-top:6px;gap:12px">'
    '<div class="c3 tight2" style="font-size:11.5px"><span class="c3n" style="font-size:20px">antes · 2015-18</span><b>Jurisprudência, não lei.</b> Súmula 543 do STJ (2015): desistiu, recebe de volta, e já; retenção arbitrada pelo juiz, em regra 10% a 25% do pago. Corretagem ao comprador se informada (Tema 938). Sem tolerância em lei para atraso de obra. O distrato virou opção gratuita: 19% das vendas brutas da Cury em 2017.</div>'
    ...
    '<div class="c3 tight2" style="font-size:11.5px"><span class="c3n" style="font-size:20px">testada? · em parte</span><b>O STJ não fechou o teto.</b> 4ª Turma (REsp 2.159.971, 15/06/26, unânime): 50% com afetação é lícito se pactuado; reafirmado em set/26. 3ª Turma reduz judicialmente (CDC, art. 413 do CC). A 2ª Seção afetou sete recursos como repetitivos (Temas 1.464 a 1.466), sem data. Contratos pré-dez/18 seguem a súmula. O 1% ao mês já custou R$ 18 mi à Cury no 2T26 (5 obras).</div></div>')
_db = ('<div class="viz" style="margin-top:6px">' + DF["svg"] + '</div>' + _cards
    + _obox(f'A lei tirou o distrato grátis: Cury de {fmt(_dn["cury_2017"], 0)}% das vendas brutas (2017) para {fmt(_dn["cury_2025"], 0)}% (2025); provisão da Cyrela em R$ {fmt(_dn["cy_saldo"], 0)} mi, {fmt(_dn["cy_saldo"] / _dn["cy_saldo_1T20"], 1)}x a de 2020.',
            f'O teto de 50% com afetação está nos repetitivos do STJ; para a Vivaz (afetação em todo MCMV) é reter metade ou o juiz arbitrar. Follow-up: Temas 1.464-1.466 e os distratos do 2S26.'))
_dsl = sl("anexo · follow-up · Lei do Distrato", "Lei do Distrato: antes, a lei e o que o STJ já testou.", _db, cls="anexo",
    nota="Fontes: Lei 13.786/2018 (arts. 35-A, 43-A e 67-A da Lei 4.591/1964); STJ, Súmula 543 (2015) e Tema 938 (2016); AgInt no REsp 2.159.971/SP (4ª Turma, rel. min. Antonio Carlos Ferreira, j. 15/06/2026, DJEN 18/06/2026) e EDcl no AgInt no REsp 2.221.464/SP (4ª Turma, rel. min. Raul Araújo, set/2026); 2ª Seção, Temas repetitivos 1.464, 1.465 e 1.466 (afetados, sem julgamento de mérito); Cury: planilha Fundamentos do RI (distratos e vendas brutas, unidades e VGV) e call 2T26 (R$ 18 mi de obrigações contratuais por atraso em 5 de 90 obras); Cyrela: notas de estoques dos ITR (provisão para distratos: saldo, adições e reversões) e releases (linha 'Provisão para distrato' na dedução da receita bruta). Não há lei nova em 2025-26: a 'nova lei' é a de 2018 sendo interpretada; o que muda agora é a jurisprudência."
