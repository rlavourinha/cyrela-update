...
if _cq.get("4T25", {}).get("rep"):
    ...
    _yt = c.y(_vmax * 0.83)   # rótulo no alto, à esquerda do pico (a faixa de 1,5 estava sobre a linha da receita)
