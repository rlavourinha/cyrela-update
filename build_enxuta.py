...
_scv = sl("parte 5 · atualização operacional · MCMV", "Cury × Vivaz: a Cury vende mais rápido, com ticket maior.",
    ...
    + _obox(f'Na mesma idade a Cury vende mais: {_cv["saf8"]} aos {_cv["idade8"]} meses, {fmt(_cv["cury8"], 0)}% contra {fmt(_cv["vivaz8"], 0)}%; VSO de {fmt(_cv["vso_cury"], 0)}% contra {fmt(_cv["vso_vivaz"], 0)}% no 2T26.',
